...
int main() {
	...
	printf("TEST 1: choice1 = 1; choice2 = silver = trash copper and add silver from the supply\n");
	...
	if (cardEffect_Mine(thisPlayer, choice1, choice2, &testG, handPos) < 0) {
	...
	printf("TEST 2: choice1 = 1; choice2 = gold = trash silver and add gold from the supply\n");
	...
	printf("TEST 3: choice1 = 1; choice2 = gold = trash copper and try to add gold from the supply\n");
