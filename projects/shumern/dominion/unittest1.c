...
int main() {
	...
	if (cardEffect_Baron(thisPlayer, choice1, &testG) < 0) {
	...
	// ----------- TEST 4:  choice1 = 1 = test my bug - discard Estate card using first card in hand --------------
	printf("TEST 4: choice1 = 1 = test my bug - discard Estate card using first card in hand\n");
